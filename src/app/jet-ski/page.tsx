              ...
              <ScrollReveal key={s.title} delay={i * 100}>
                <div className="group relative h-72 rounded-2xl overflow-hidden shadow-lg">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    <h3 className="text-lg font-extrabold text-white mb-1">{s.title}</h3>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <ScrollReveal>
            ...
            <p className="text-white/80 text-lg mb-8 max-w-xl mx-auto">Book your jet ski adventure and experience the thrill of Assateague Bay.</p>
